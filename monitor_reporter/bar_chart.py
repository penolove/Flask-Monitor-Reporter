...
def generate_bar_chart_tuples(start_time, end_time):
...
# TODO: add channel endpoint for query
def generate_bar_chart_tuples_with_channels(channels, start_time, end_time):
    label_counter = defaultdict(list)
